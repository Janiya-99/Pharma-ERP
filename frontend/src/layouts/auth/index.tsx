...
export default function Auth() {
  ...
  return (
    <div 
      className="relative flex h-screen w-screen items-center justify-center bg-pharmaBgLight p-4 md:p-8 font-dm overflow-hidden"
      style={{ zoom: 0.85 }}
    >
      ...
      {/* Main App Container */}
      <div className="relative flex w-full max-w-[1400px] h-full max-h-[850px] flex-col rounded-[24px] sm:rounded-[32px] bg-pharmaDark shadow-2xl overflow-hidden z-10">
        
        {/* Header */}
        <header className="flex h-16 sm:h-20 w-full shrink-0 items-center justify-between px-6 sm:px-8 lg:px-12 pt-4">
        ...
        {/* Main Content Area */}
        <main className="flex flex-1 flex-col relative z-10 overflow-hidden pb-12">
          <Routes>
            {getRoutes(routes)}
        ...
        <div className="absolute bottom-6 left-4 sm:left-8 lg:left-12 flex w-[calc(100%-2rem)] sm:w-[calc(100%-6rem)] items-end justify-between z-20 pointer-events-none">
          {/* Support Widget */}
          <div className="hidden sm:flex items-center gap-3 rounded-full bg-white p-2 pr-6 shadow-xl pointer-events-auto cursor-pointer hover:scale-105 transition-transform">
