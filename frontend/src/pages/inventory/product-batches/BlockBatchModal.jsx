...
const BlockBatchModal = ({ isOpen, onClose, onSave, batch }) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Block Batch">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea required rows={3} value={reason} onChange={(e) => setReason(e.target.value)} className="w-full px-3 py-2 border rounded-xl" />
        </div>
