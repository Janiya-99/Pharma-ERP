...
const ProductBatchesPage = () => {
  ...
  const columns = [
    ...
    { header: "Mfg Date", accessorKey: "manufacture_date", cell: ({ row }) => row.original.manufacture_date ? new Date(row.original.manufacture_date).toLocaleDateString() : "-" },
    { 
      header: "Exp Date", 
    ...
    { header: "Purchase Rate", accessorKey: "purchase_rate", cell: ({ row }) => Number(row.original.purchase_rate).toFixed(2) },
    { header: "Selling Price", accessorKey: "selling_price", cell: ({ row }) => Number(row.original.selling_price).toFixed(2) },
    { 
      header: "Status", 
      id: "status",
      cell: ({ row }) => (
