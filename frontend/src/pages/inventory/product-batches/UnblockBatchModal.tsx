...
const UnblockBatchModal = ({ isOpen, onClose, onSave, batch }: { isOpen?: boolean; onClose?: unknown; onSave?: unknown; batch?: unknown }) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Unblock Batch">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <button type="submit" disabled={loading} className="px-4 py-2 bg-green-600 text-white rounded-xl text-sm disabled:opacity-50">Confirm Unblock</button>
        </div>
      </form>
    </Modal>
  );
