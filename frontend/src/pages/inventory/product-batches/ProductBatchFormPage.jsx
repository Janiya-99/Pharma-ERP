...
const ProductBatchFormPage = () => {
  ...
  useEffect(() => {
    if (formData.product_id) {
      ...
      inventoryApi.getProductById(formData.product_id).then(res => {
      ...
      <div className="bg-white dark:bg-navy-800 rounded-2xl shadow-sm border border-gray-100 dark:border-navy-700 p-6">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            ...
            <ProductSelect value={formData.product_id} onChange={(v) => handleCustomChange("product_id", v)} disabled={isEdit} />
            {productData && (
          ...
          <div>
            ...
            <SupplierSelect value={formData.supplier_id} onChange={(v) => handleCustomChange("supplier_id", v)} />
          </div>
          <div>
