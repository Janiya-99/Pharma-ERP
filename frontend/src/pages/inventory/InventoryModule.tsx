...
function KpiCard({
  ...
  const toneStyles: Record<string, { card: string; iconBg: string; text: string }> = {
    info: { card: "border-indigo-100 bg-gradient-to-br from-indigo-50/80 to-white shadow-md ring-1 ring-inset ring-indigo-100", iconBg: "bg-indigo-100 text-indigo-600 group-hover:bg-indigo-200", text: "text-indigo-600" },
    success: { card: "border-emerald-100 bg-gradient-to-br from-emerald-50/80 to-white shadow-md ring-1 ring-inset ring-emerald-100", iconBg: "bg-emerald-100 text-emerald-600 group-hover:bg-emerald-200", text: "text-emerald-600" },
    warning: { card: "border-amber-100 bg-gradient-to-br from-amber-50/80 to-white shadow-md ring-1 ring-inset ring-amber-100", iconBg: "bg-amber-100 text-amber-600 group-hover:bg-amber-200", text: "text-amber-600" },
    danger: { card: "border-rose-100 bg-gradient-to-br from-rose-50/80 to-white shadow-md ring-1 ring-inset ring-rose-100", iconBg: "bg-rose-100 text-rose-600 group-hover:bg-rose-200", text: "text-rose-600" },
    neutral: { card: "border-slate-100 bg-gradient-to-br from-slate-50/80 to-white shadow-md ring-1 ring-inset ring-slate-100", iconBg: "bg-slate-100 text-slate-600 group-hover:bg-slate-200", text: "text-slate-600" },
  };
  ...
  return (
    <div className={`group relative overflow-hidden rounded-3xl border p-4 sm:p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${t.card}`}>
      ...
      {subtext && (
        <div className="mt-3 flex items-center justify-end gap-2 border-t border-slate-100 pt-3 text-[11px]">
          <span className="text-slate-400 truncate flex-1 text-right" title={subtext}>{subtext}</span>
        </div>
      )}
    </div>
  );
