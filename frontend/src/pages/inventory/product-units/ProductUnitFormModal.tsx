...
const ProductUnitFormModal = ({ isOpen, onClose, onSave, initialData }: { isOpen?: boolean; onClose?: unknown; onSave?: unknown; initialData?: unknown }) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      if (initialData) {
        await inventoryApi.updateProductUnit(initialData.id, formData);
        toast.success("Updated successfully");
      } else {
        await inventoryApi.createProductUnit(formData);
...
export default ProductUnitFormModal;
