...
const WarehouseLocationsPage = () => {
  ...
  const columns = [
    ...
    {"header": "Condition", "accessorKey": "storage_condition", "cell": ({ row }: { row?: unknown }) => <StorageConditionBadge condition={row.original.storage_condition} /> },
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-navy-700 dark:text-white">Warehouse Locations</h1>
          <p className="text-sm text-gray-500 mt-1">Manage warehouse locations</p>
        </div>
