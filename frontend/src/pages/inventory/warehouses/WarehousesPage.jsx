...
const WarehousesPage = () => {
  ...
  const columns = [
    ...
    {"header": "Type", "accessorKey": "warehouse_type", "cell": ({ row }) => <WarehouseTypeBadge type={row.original.warehouse_type} /> },
    {"header": "Default", "accessorKey": "is_default", "cell": ({ row }) => row.original.is_default ? <span className="bg-brand-100 text-brand-700 text-xs font-semibold px-2 py-0.5 rounded">Default</span> : null },
