...
const GenericNameFormModal = ({ isOpen, onClose, onSave, initialData }: { isOpen?: boolean; onClose?: unknown; onSave?: unknown; initialData?: unknown }) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      if (initialData) {
        await inventoryApi.updateGenericName(initialData.id, formData);
        toast.success("Updated successfully");
      } else {
        await inventoryApi.createGenericName(formData);
...
export default GenericNameFormModal;
