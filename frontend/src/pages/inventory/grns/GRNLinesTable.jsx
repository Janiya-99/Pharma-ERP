...
const GRNLinesTable = ({ lines, setLines, warehouseId, errors = {} }) => {
  ...
  useEffect(() => {
    if (warehouseId) {
      ...
      setLocations([]);
      setLines(lines.map(line => ({ ...line, warehouse_location_id: "" })));
    }
  }, [warehouseId]);

  const fetchWarehouseLocations = async (wId) => {
    try {
  ...
  const handleLineChange = (index, field, value, extraData = {}) => {
                  ...
                  <tr key={line.id || index} className="hover:bg-gray-50 dark:hover:bg-navy-800/50">
                    <td className="px-4 py-3 align-top">
                      <GRNLineProductSelect
                        ...
                        onChange={(val, product) => handleLineChange(index, "product_id", val, { product })}
                        ...
                        {!line.is_new_batch ? (
                          <>
                            <GRNLineBatchSelect
                              ...
                              onChange={(val, batch) => handleLineChange(index, "product_batch_id", val, { batch })}
                            ...
                            <div className="flex gap-2">
                              <div className="w-1/2">
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleLineChange(index, "manufacture_date", e.target.value)}
                    ...
                    <td className="px-4 py-3 align-top">
                      <select
                        ...
                        onChange={(e) => handleLineChange(index, "warehouse_location_id", e.target.value ? parseInt(e.target.value) : null)}
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleLineChange(index, "quantity_received", e.target.value)}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={(e) => handleLineChange(index, "free_quantity", e.target.value)}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleLineChange(index, "tax_amount", e.target.value)}
                    ...
                    <td className="px-4 py-3 align-top">
                      <div className="flex flex-col gap-2">
                        <textarea
                          ...
                          onChange={(e) => handleLineChange(index, "line_remarks", e.target.value)}
