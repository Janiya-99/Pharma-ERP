...
const DosageFormFormModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (initialData) {
        await inventoryApi.updateDosageForm(initialData.id, formData);
        toast.success("Updated successfully");
      } else {
        await inventoryApi.createDosageForm(formData);
...
export default DosageFormFormModal;
