...
const StockBalancesPage = () => {
  ...
  const columns = [
    ...
    { header: "Expiry", accessorKey: "batch.expiry_date", cell: ({ row }) => {
    ...
    { header: "Location", accessorKey: "location.location_name", cell: ({ row }) => row.original.location?.location_name || "-" },
    { header: "Qty On Hand", accessorKey: "quantity_on_hand", cell: ({ row }) => <StockQuantityDisplay quantity={row.original.quantity_on_hand} /> },
    { header: "Qty Allocated", accessorKey: "quantity_allocated", cell: ({ row }) => <StockQuantityDisplay quantity={row.original.quantity_allocated} /> },
    { header: "Qty Available", accessorKey: "quantity_available", cell: ({ row }) => <StockQuantityDisplay quantity={row.original.quantity_available} /> },
    { header: "Avg Cost", accessorKey: "average_cost", cell: ({ row }) => <StockValueDisplay value={row.original.average_cost} /> },
    { header: "Stock Value", accessorKey: "stock_value", cell: ({ row }) => <StockValueDisplay value={row.original.stock_value} /> },
  ];
