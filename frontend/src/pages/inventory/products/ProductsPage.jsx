...
const ProductsPage = () => {
  ...
  const columns = [
    ...
    { header: "Type", accessorKey: "product_type", cell: ({ row }) => <ProductTypeBadge type={row.original.product_type} /> },
    ...
    { header: "Storage", accessorKey: "storage_condition", cell: ({ row }) => <StorageConditionBadge condition={row.original.storage_condition} /> },
