...
const OpeningStockEntriesPage = () => {
  ...
  const columns = [
    ...
    { header: "Date", accessorKey: "opening_stock_date", cell: ({ row }) => formatDate(row.original.opening_stock_date) },
    { header: "Warehouse", accessorKey: "warehouse_id", cell: ({ row }) => row.original.warehouse?.warehouse_name || row.original.warehouse_id },
    ...
    { header: "Total Value", accessorKey: "total_stock_value", cell: ({ row }) => formatCurrency(row.original.total_stock_value) },
    { header: "Approval", accessorKey: "approval_status", cell: ({ row }) => <OpeningStockStatusBadge status={row.original.approval_status} /> },
    { header: "Posted", accessorKey: "posted_status", cell: ({ row }) => <InventoryPostedStatusBadge status={row.original.posted_status} /> },
  ];
