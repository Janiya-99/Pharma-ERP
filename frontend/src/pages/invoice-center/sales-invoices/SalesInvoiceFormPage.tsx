...
import { ArrowLeft, Save, FileText, Check, Copy } from "lucide-react";
...
import { 
  ...
  SalesInvoiceStockAvailabilityCard,
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      <div className="flex items-center justify-between">
        ...
        <PermissionGuard requiredPermission={isEdit ? "invoice_center.sales_invoice.update" : "invoice_center.sales_invoice.create"}>
