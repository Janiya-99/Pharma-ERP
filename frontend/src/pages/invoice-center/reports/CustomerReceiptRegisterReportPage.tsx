...
import {
  ...
  CustomerReceiptRegisterReportRow,
...
export const CustomerReceiptRegisterReportPage: React.FC = () => {
  ...
  const [data, setData] = useState<{
    summary: any;
    rows: CustomerReceiptRegisterReportRow[];
  } | null>(null);
  ...
  const fetchData = async () => {
    try {
      ...
      if (cleanFilters.payment_method === "all")
        delete cleanFilters.payment_method;
      ...
      if (cleanFilters.receipt_status === "all")
        delete cleanFilters.receipt_status;
      if (cleanFilters.finance_post_status === "all")
        delete cleanFilters.finance_post_status;

      const res = await invoiceCenterApi.getCustomerReceiptRegisterReport(
        cleanFilters
      );
  ...
  const columns: ColumnDef<CustomerReceiptRegisterReportRow>[] = [
    ...
    { header: "Customer Name", accessorKey: "customer_name" },
    {
      ...
      cell: (row) => <Badge variant="outline">{row.payment_method}</Badge>,
      align: "center",
    },
    {
      header: "Amount",
  ...
  const summaryCards: SummaryCardItem[] = [
    ...
    },
    {
      ...
      value: summary.receipt_amount || 0,
      format: "currency",
    ...
    },
    {
      ...
      value: summary.unallocated_amount || 0,
      format: "currency",
  ...
  return (
    <ReportPageShell
      ...
      actions={
        <ReportExportActions
          data={data}
          filename={`customer-receipt-register-${
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(val) =>
                setFilters((prev) => ({ ...prev, payment_method: val }))
              }
            >
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(val) =>
                setFilters((prev) => ({ ...prev, receipt_status: val }))
              }
            >
