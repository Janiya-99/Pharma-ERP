...
export const CreditNoteRegisterReportPage: React.FC = () => {
  ...
  const [data, setData] = useState<{
    summary: any;
    rows: CreditNoteRegisterReportRow[];
  } | null>(null);
  ...
  const fetchData = async () => {
    try {
      ...
      if (cleanFilters.credit_note_type === "all")
        delete cleanFilters.credit_note_type;
  ...
  const columns: ColumnDef<CreditNoteRegisterReportRow>[] = [
    ...
    {
      header: "Type",
      cell: (row) => <Badge variant="outline">{row.credit_note_type}</Badge>,
      align: "center",
    },
    {
      header: "Subtotal",
  ...
  const summaryCards: SummaryCardItem[] = [
    {
      ...
      value: summary.credit_note_count || 0,
      format: "number",
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(val) =>
                setFilters((prev) => ({ ...prev, credit_note_type: val }))
              }
            >
