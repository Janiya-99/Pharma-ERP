...
export const createBlankDebitNoteLine = () => ({
...
export const DebitNoteLinesTable: React.FC<Props> = ({ control, register, setValue, watch, errors }) => {
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          onClick={() => append(createBlankDebitNoteLine())}
        >
