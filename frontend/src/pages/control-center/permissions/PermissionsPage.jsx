  ...
  const columns = [
    {
      ...
      cell: (row) => row.software_module?.software_name || "-",
    },
    {
      header: "Permission Group",
      accessor: "permission_group",
      cell: (row) => <span className="capitalize">{row.permission_group.replace(/_/g, " ")}</span>,
    },
    {
    ...
    },
    {
      ...
      cell: (row) => <span className="font-mono text-xs bg-gray-100 px-1.5 py-0.5 rounded text-gray-700">{row.permission_key}</span>,
    },
    {
      header: "Description",
