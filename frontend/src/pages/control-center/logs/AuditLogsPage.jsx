...
const AuditLogsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      header: "User",
      accessor: "user_name",
      cell: (row) => row.user?.full_name || row.user_name || "System"
    },
    {
      header: "Branch",
      accessor: "branch_name",
      cell: (row) => row.branch?.branch_name || row.branch_name || "-"
    },
    {
      header: "Software",
      accessor: "software_name",
      cell: (row) => row.software_module?.software_name || row.software_name || "-"
    },
    {
      header: "Action",
      accessor: "action",
    ...
    },
    {
      header: "Entity ID",
      accessor: "entity_id",
      cell: (row) => <span className="font-mono text-xs text-gray-600">{row.entity_id || "-"}</span>
    },
    {
      header: "IP Address",
      accessor: "ip_address",
      cell: (row) => <span className="font-mono text-xs text-gray-500">{row.ip_address || "-"}</span>
    },
    {
      header: "Actions",
      cellClassName: "text-right",
      cell: (row) => <ActionMenu actions={getRowActions(row)} item={row} />,
    },
  ];
