...
const UsersPage = () => {
  ...
  const getRowActions = (row) => [
    {
      ...
      onClick: (r) => navigate(`/control-center/users/${r.id}`),
    },
    {
      label: "Edit User",
      icon: Edit2,
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => row.department?.department_name || row.department_id || "-",
    },
    {
      header: "Designation",
      accessor: "designation_id",
      cell: (row) => row.designation?.designation_name || row.designation_id || "-",
    },
    {
      header: "User Type",
      accessor: "user_type",
