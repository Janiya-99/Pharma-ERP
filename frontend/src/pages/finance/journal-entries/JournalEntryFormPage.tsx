...
export default function JournalEntryFormPage() {
  ...
  const isBalanced = 
    lines.reduce((s: unknown, l: unknown) => s + (Number(l.debit_amount) || 0), 0) > 0 &&
    lines.reduce((s: unknown, l: unknown) => s + (Number(l.debit_amount) || 0), 0) === lines.reduce((s: unknown, l: unknown) => s + (Number(l.credit_amount) || 0), 0);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e: any) => setFormData((prev: unknown) => ({ ...prev, journal_date: e.target.value }))}
