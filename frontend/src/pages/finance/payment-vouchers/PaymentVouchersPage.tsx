      ...
      <FinancePageHeader
        ...
        onAdd={
          hasPermission("finance.payment.create")
            ? () => history.push("/admin/finance/payment-vouchers/create")
            : undefined
        }
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
          ...
          <input
            ...
            onChange={(e: any) =>
              setFilters((prev: unknown) => ({
                ...prev,
                payment_date_from: e.target.value,
              }))
            }
            className="w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-1 focus:ring-navy-500"
          ...
          <input
            ...
            onChange={(e: any) =>
              setFilters((prev: unknown) => ({
                ...prev,
                payment_date_to: e.target.value,
              }))
            }
            className="w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-1 focus:ring-navy-500"
                  ...
                  >
                    <td className="px-4 py-3 font-medium text-navy-700">
                      <button
                        onClick={() =>
                          history.push(
                            `/admin/finance/payment-vouchers/${voucher.id}`
                          )
                        }
