...
const FixedAssetDisposalFormPage = () => {
  ...
  const handleAssetChange = (assetId: string | number, assetFullData: unknown) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: any) => setFormData({ ...formData, disposal_date: e.target.value })}
                  />
                ...
                {formData.disposal_type === "sale" && (
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: any) => setFormData({ ...formData, sale_value: e.target.value })}
                    />
