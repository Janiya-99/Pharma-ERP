...
const FixedAssetDisposalDetailsPage = () => {
  ...
  const handleAction = async (actionFn, modalSetter, successMsg, remarks = "") => {
    try {
      setActionLoading(true);
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-navy-900 overflow-y-auto pb-10">
      ...
      <ActionDisposalModal
        ...
        onConfirm={(remarks) => handleAction(financeApi.submitFixedAssetDisposal, setSubmitModalOpen, "Disposal submitted for approval", remarks)}
      ...
      <ActionDisposalModal
        ...
        onConfirm={(remarks) => handleAction(financeApi.approveFixedAssetDisposal, setApproveModalOpen, "Disposal approved", remarks)}
        loading={actionLoading}
      ...
      <ActionDisposalModal
        ...
        onConfirm={(remarks) => handleAction(financeApi.rejectFixedAssetDisposal, setRejectModalOpen, "Disposal rejected", remarks)}
        loading={actionLoading}
