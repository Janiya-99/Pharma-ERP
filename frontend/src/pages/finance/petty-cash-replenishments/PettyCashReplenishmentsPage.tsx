  ...
  return (
    <div className="flex h-full flex-col gap-4 py-4">
      <FinancePageHeader
        ...
        onAdd={
          hasPermission("finance.petty_cash_replenishment.create")
            ? () =>
                history.push("/admin/finance/petty-cash-replenishments/create")
            : undefined
        }
      ...
      <div className="flex-1 overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm dark:border-navy-700 dark:bg-navy-800">
              ...
              {loading ? (
                ...
                <tr>
                  <td
                    ...
                    className="px-4 py-8 text-center text-gray-500"
                  >
                    No petty cash replenishments found.
                  </td>
                </tr>
              ) : (
                replenishments.map((r: unknown) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right font-medium">
                      <MoneyDisplay amount={r.replenishment_amount} />
                    </td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <div className="flex flex-col items-center justify-center gap-2">
                        <div className="flex items-center gap-2">
                          {hasPermission(
                            "finance.petty_cash_replenishment.view"
                          ) && (
                            <button
                              onClick={() =>
                                history.push(
                                  `/admin/finance/petty-cash-replenishments/${r.id}`
                                )
                              }
                        ...
                        <PettyCashActionButtons
                          ...
                          onEdit={() =>
                            history.push(
                              `/admin/finance/petty-cash-replenishments/${r.id}/edit`
                            )
                          }
                          onDelete={() => handleDelete(r.id)}
                          onSubmit={() => {
                            setActionReplenishmentId(r.id);
        ...
        <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-4 py-3 text-gray-500 dark:border-navy-700 dark:bg-navy-800 dark:text-gray-400">
          ...
          <div className="flex gap-2">
            ...
            <button
              disabled={replenishments.length < pagination.limit}
              onClick={() =>
                setPagination((prev: unknown) => ({
                  ...prev,
                  page: prev.page + 1,
      ...
      <PostPettyCashConfirmModal
        ...
        onConfirm={() =>
          handleAction(
            financeApi.postPettyCashReplenishment,
            actionReplenishmentId,
            undefined,
            "post"
          )
