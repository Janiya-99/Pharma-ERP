...
const RebuildLedgerModal = ({
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await financeApi.rebuildGeneralLedger({
  ...
  const isConfirmDisabled =
    !financialYearId || confirmationText !== "REBUILD" || isSubmitting;
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 dark:text-red-300">
                This will rebuild ledger entries for the selected financial year
                from posted transactions. This action should only be used by
                Finance Managers. Existing entries for the selected year will be
        ...
        <div className="space-y-2">
          <Label className="font-semibold text-red-600">
            Select Financial Year to Rebuild{" "}
        ...
        <div className="space-y-2">
          <Label>
            Type <strong className="select-none">REBUILD</strong> to confirm
          </Label>
          <Input
            type="text"
            placeholder="REBUILD"
