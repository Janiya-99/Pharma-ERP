...
const FixedAssetDepreciationRunFormPage = () => {
  ...
  const handleFinancialYearChange = async (fyId) => {
  ...
  const handleAccountingPeriodChange = (apId) => {
    const period = accountingPeriods.find(p => p.id === Number(apId));
    setFormData({ 
      ...formData, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => handleAccountingPeriodChange(e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, depreciation_from_date: e.target.value })}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, depreciation_to_date: e.target.value })}
              />
