...
const FixedAssetDepreciationRunsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, row) => <span>{row.financial_year?.year_name}</span>,
    },
    {
      key: "accounting_period",
      label: "Accounting Period",
      render: (_, row) => <span>{row.accounting_period?.period_name}</span>,
    },
    {
    ...
    },
    {
      ...
      align: "right",
      render: (val) => <span className="font-bold text-red-600 dark:text-red-400">LKR {Number(val || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>,
    },
    {
      key: "posted_status",
      label: "Status",
      align: "center",
      render: (val) => <DepreciationPostedStatusBadge status={val} />,
    },
    {
      key: "actions",
      label: "Actions",
