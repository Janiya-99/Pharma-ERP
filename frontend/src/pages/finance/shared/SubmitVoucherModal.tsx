...
export default function SubmitVoucherModal({ isOpen, onClose, voucher, type, onSuccess }: { isOpen?: boolean; onClose?: unknown; voucher?: unknown; type?: unknown; onSuccess?: unknown }) {
