    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Approve Record" size="md">
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <textarea
            className="mt-1 block w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-green-500 focus:ring-green-500 dark:border-navy-700 dark:bg-navy-900 dark:text-white sm:text-sm"
            rows="3"
            value={remarks}
