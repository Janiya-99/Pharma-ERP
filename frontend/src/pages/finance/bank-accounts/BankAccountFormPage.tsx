...
export default function BankAccountFormPage() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (formData.is_default) {
      if (
        !window.confirm(
          "Setting this as default will unset any existing default bank account. Proceed?"
        )
      ) {
        return;
      }
        ...
        <div className="mb-6 flex items-center justify-between border-b pb-4 dark:border-navy-700">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Fill out the details to {isEdit ? "update" : "create"} a bank
              account.
            </p>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                disabled={isEdit}
                className="w-full rounded-md border bg-gray-50 px-3 py-2 disabled:text-gray-500"
              />
              {isEdit && (
