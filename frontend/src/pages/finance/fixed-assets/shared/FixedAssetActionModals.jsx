...
export const PostDepreciationConfirmModal = ({ isOpen, onClose, onConfirm, loading }) => {
  return (
...
export const PostDisposalConfirmModal = ({ isOpen, onClose, onConfirm, loading }) => {
  return (
...
export const ActionDisposalModal = ({ isOpen, onClose, onConfirm, loading, title, actionLabel, colorClass, requireRemarks }) => {
