  ...
  const columns = [
    {
      key: "asset_code",
      label: "Code",
      render: (val) => <span className="font-bold text-navy-700 dark:text-white">{val}</span>,
    },
    {
      key: "asset_name",
      label: "Asset Name",
      render: (val) => <span className="font-medium text-gray-800 dark:text-gray-200">{val}</span>,
    },
    {
      key: "category",
      label: "Category",
      render: (_, row) => <span>{row.category?.category_name}</span>,
    },
    {
      key: "branch",
      label: "Branch",
      render: (_, row) => <span>{row.branch?.branch_name}</span>,
    },
    {
      key: "purchase_date",
      label: "Purchase Date",
    ...
    },
    {
      ...
      align: "right",
      render: (val) => <span>LKR {Number(val || 0).toLocaleString()}</span>,
    },
    {
    ...
    },
    {
      ...
      align: "right",
      render: (val) => <span className="font-medium text-brand-600 dark:text-brand-400">LKR {Number(val || 0).toLocaleString()}</span>,
    },
    {
      key: "asset_status",
      label: "Asset Status",
      align: "center",
      render: (val) => <FixedAssetStatusBadge status={val} />,
    },
    {
      key: "actions",
      label: "Actions",
