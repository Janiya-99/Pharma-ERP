...
export const FixedAssetCategoriesPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Define asset categories, control accounts, and depreciation defaults.",
...
export const FixedAssetsPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      title: "Fixed Assets",
      description:
        "Register fixed assets and connect them to asset and depreciation accounts.",
...
export const DepreciationRunsPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Prepare periodic depreciation runs for active fixed assets.",
...
export const AssetDisposalsPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Record asset sales, write-offs, and disposal gains or losses.",
