              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ChartOfAccountSelect
                    ...
                    onChange={(val) => setFormData({ ...formData, accumulated_depreciation_account_id: val })}
                ...
                <div>
                  ...
                  <ChartOfAccountSelect
                    ...
                    onChange={(val) => setFormData({ ...formData, depreciation_expense_account_id: val })}
                ...
                <div>
                  ...
                  <ChartOfAccountSelect
                    ...
                    onChange={(val) => setFormData({ ...formData, gain_on_disposal_account_id: val })}
                  />
                </div>
                <div>
                  ...
                  <ChartOfAccountSelect
                    ...
                    onChange={(val) => setFormData({ ...formData, loss_on_disposal_account_id: val })}
                  />
                </div>
              </div>
            </div>
