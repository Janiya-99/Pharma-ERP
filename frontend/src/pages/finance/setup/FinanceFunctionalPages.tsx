...
import {
  ...
  QuickField,
} from "../shared/FinanceQuickResourcePage";
...
const optionalBranchField: QuickField = {
  name: "branch_id",
  label: "Branch",
  type: "select",
  source: "branches",
};
const financialYearField: QuickField = {
  name: "financial_year_id",
  label: "Financial Year",
  type: "select",
  source: "financialYears",
  required: true,
};
const accountingPeriodField: QuickField = {
...
export const OpeningBalancesPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Capture opening debit and credit balances before posting finance transactions.",
...
export const FinancialYearPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Configure financial years and close controls for ledger reporting.",
...
export const JournalEntryPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      title: "Journal Entry",
      description:
        "Create balanced debit and credit journal vouchers that post to the general ledger.",
...
export const PaymentVouchersPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Create payment vouchers that reduce linked bank or cash balances.",
      ...
      fields: [
        ...
        { name: "description", label: "Description", type: "textarea" },
        {
          ...
          required: true,
          defaultValue: [
            { account_id: 0, line_description: "Payment line", amount: 0 },
          ],
        },
      ],
    }}
...
export const ReceiptVouchersPage = () => (
  <FinanceQuickResourcePage
    config={{
      ...
      description:
        "Create receipt vouchers that increase linked bank or cash balances.",
      ...
      fields: [
        ...
        { name: "description", label: "Description", type: "textarea" },
        {
          ...
          required: true,
          defaultValue: [
            { account_id: 0, line_description: "Receipt line", amount: 0 },
          ],
        },
      ],
    }}
