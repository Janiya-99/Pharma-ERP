...
const ReceiptRegisterReportPage = () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message ||
          "Failed to fetch receipt register report"
      );
      setData(null);
    } finally {
      setLoading(false);
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          You do not have permission to view the Receipt Register report.
        </p>
      </div>
    );
  }
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row: unknown) =>
        row.receipt_method.charAt(0).toUpperCase() +
        row.receipt_method.slice(1),
    },
    {
      header: "Received To",
      ...
      cell: (row: unknown) => (
        <div
          ...
          title={row.received_to_account_name}
        >
          {row.received_to_account_name || "-"}
        </div>
      ),
    },
    {
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(val: unknown) =>
              handleFilterChange("receipt_method", val)
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(val: unknown) =>
              handleFilterChange("receipt_type", val)
            }
          >
            <SelectTrigger>
