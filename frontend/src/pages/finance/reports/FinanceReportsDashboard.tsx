...
const FinanceReportsDashboard = () => {
  ...
  const reportCards = [
    {
      ...
      description:
        "Detailed chronological record of all transactions for a specific account.",
    ...
    },
    {
      title: "Trial Balance",
      description:
        "Summary of closing balances for all accounts to verify double-entry accounting.",
    ...
    },
    {
      ...
      description:
        "Financial performance summary showing revenues, costs, and expenses over a period.",
    ...
    },
    {
      title: "Day Book",
      description:
        "Chronological daily summary of all accounting transactions.",
      path: "/finance/reports/day-book",
      permission: "finance.report.day_book.view",
      icon: <Clock className="text-rose-500 h-6 w-6" />,
    },
    {
      title: "Journal Register",
      description:
        "Log of all manual journal entries with their approval and posting status.",
    ...
    },
    {
      ...
      description:
        "Log of all payment vouchers with their approval and posting status.",
    ...
    },
    {
      ...
      description:
        "Log of all receipt vouchers with their approval and posting status.",
  ...
  const visibleCards = reportCards.filter((card: unknown) =>
      ...
      {visibleCards.length === 0 ? (
        <div className="rounded-lg border border-gray-200 bg-white p-8 text-center shadow dark:border-navy-700 dark:bg-navy-800">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            You do not have permission to view any finance reports. Contact your
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {visibleCards.map((card: unknown, index: unknown) => (
            <Card
              key={index}
              className="flex flex-col border-gray-200 shadow-sm transition-shadow hover:shadow-md dark:border-navy-700"
            >
              <CardHeader className="flex flex-row items-center gap-4 pb-2">
                <div className="rounded-lg bg-gray-50 p-3 dark:bg-navy-900">
                  {card.icon}
                </div>
                <div>
                  <CardTitle className="text-lg text-navy-800 dark:text-white">
                    {card.title}
                  </CardTitle>
                </div>
              </CardHeader>
              ...
              <CardFooter className="border-t border-gray-100 pt-4 dark:border-navy-700">
                <Button
                  variant="ghost"
