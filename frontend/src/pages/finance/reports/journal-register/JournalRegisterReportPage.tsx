...
const JournalRegisterReportPage = () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message ||
          "Failed to fetch journal register report"
      );
      setData(null);
    } finally {
      setLoading(false);
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          You do not have permission to view the Journal Register report.
        </p>
      </div>
    );
  }
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row: unknown) => (
        <div className="max-w-[150px] truncate" title={row.description}>
          {row.description || "-"}
        </div>
      ),
    },
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(val: unknown) =>
              handleFilterChange("approval_status", val)
            }
          >
            <SelectTrigger>
