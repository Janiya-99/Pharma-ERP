...
const FixedAssetCategoriesPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: "Asset Account",
      render: (_, row) => <span>{row.default_asset_account?.account_code} - {row.default_asset_account?.account_name}</span>,
    },
    {
      key: "default_depreciation_expense_account",
      label: "Depreciation Exp Account",
      render: (_, row) => <span>{row.default_depreciation_expense_account?.account_code} - {row.default_depreciation_expense_account?.account_name}</span>,
    },
    {
    ...
    },
    {
      ...
      render: (val) => <DepreciationMethodBadge method={val} />,
    },
    {
      key: "status",
      label: "Status",
