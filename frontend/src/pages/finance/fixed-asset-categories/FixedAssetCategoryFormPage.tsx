...
const FixedAssetCategoryFormPage = () => {
      ...
      if (data) {
        setFormData({
          ...
          default_accumulated_depreciation_account_id:
            data.default_accumulated_depreciation_account_id || null,
          default_depreciation_expense_account_id:
            data.default_depreciation_expense_account_id || null,
          default_gain_on_disposal_account_id:
            data.default_gain_on_disposal_account_id || null,
          default_loss_on_disposal_account_id:
            data.default_loss_on_disposal_account_id || null,
          default_useful_life_months: data.default_useful_life_months || "",
          default_depreciation_method:
            data.default_depreciation_method || "straight_line",
  ...
  const validate = () => {
    ...
    if (!formData.default_asset_account_id)
      newErrors.default_asset_account_id = "Default Asset Account is required";
    if (!formData.default_accumulated_depreciation_account_id)
      newErrors.default_accumulated_depreciation_account_id =
        "Accumulated Depreciation Account is required";
    if (!formData.default_depreciation_expense_account_id)
      newErrors.default_depreciation_expense_account_id =
        ...
        {isEdit && (
          <div className="mb-6 rounded-xl border border-blue-100 bg-blue-50 p-4 dark:border-blue-800/30 dark:bg-blue-900/20">
            <p className="text-sm text-blue-700 dark:text-blue-400">
              <span className="font-bold">Note:</span> Updating category default
              accounts or useful life will{" "}
              <span className="font-bold">not</span> automatically update
              existing fixed assets linked to this category.
            </p>
          </div>
        )}
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val: unknown) =>
                  setFormData({ ...formData, default_asset_account_id: val })
                }
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val: unknown) =>
                  setFormData({
                    ...formData,
                    default_accumulated_depreciation_account_id: val,
                  })
                }
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val: unknown) =>
                  setFormData({
                    ...formData,
                    default_depreciation_expense_account_id: val,
                  })
                }
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val: unknown) =>
                  setFormData({
                    ...formData,
                    default_gain_on_disposal_account_id: val,
                  })
                }
              />
            </div>
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val: unknown) =>
                  setFormData({
                    ...formData,
                    default_loss_on_disposal_account_id: val,
                  })
                }
              />
            </div>
