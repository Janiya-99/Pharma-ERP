          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val) => setFormData({ ...formData, default_asset_account_id: val })}
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val) => setFormData({ ...formData, default_accumulated_depreciation_account_id: val })}
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val) => setFormData({ ...formData, default_depreciation_expense_account_id: val })}
            ...
            <div>
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val) => setFormData({ ...formData, default_gain_on_disposal_account_id: val })}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <ChartOfAccountSelect
                ...
                onChange={(val) => setFormData({ ...formData, default_loss_on_disposal_account_id: val })}
              />
            </div>
          </div>
        </div>
