        ...
        <div className="space-y-4">
          <div className="flex justify-between items-end">
            <div>
              ...
              <div className="text-sm font-semibold text-emerald-600 ">{money(data.cash_in)}</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-gray-500">Cash Out</div>
              <div className="text-sm font-semibold text-rose-600 ">{money(data.cash_out)}</div>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between text-xs mb-1">
              ...
              <span className="font-medium text-gray-900 ">{data.outflow_ratio}%</span>
            </div>
            <div className="h-2 w-full overflow-hidden rounded-full bg-gray-100 ">
              <div
                className={`h-full rounded-full transition-all ${
                  data.outflow_ratio > 80 ? 'bg-amber-500 ' : 'bg-emerald-500 '
                }`}
