...
const routes: ERPRoute[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "finance/account-classifications",
      ...
      },
      {
        ...
        component: <PaymentVoucherFormPage />,
        hide: true,
      },
      {
        name: "Edit Payment Voucher",
        path: "finance/payment-vouchers/:id/edit",
        component: <PaymentVoucherFormPage />,
        hide: true,
      },
      {
        ...
        component: <PaymentVoucherDetailsPage />,
        hide: true,
      },
      {
        name: "Receipt Vouchers",
        path: "finance/receipt-vouchers",
        component: <ReceiptVouchersPage />,
      },
      {
        name: "Create Receipt Voucher",
        path: "finance/receipt-vouchers/create",
        component: <ReceiptVoucherFormPage />,
        hide: true,
      },
      {
        name: "Edit Receipt Voucher",
        path: "finance/receipt-vouchers/:id/edit",
        component: <ReceiptVoucherFormPage />,
        hide: true,
      },
      {
        name: "Receipt Voucher Details",
        path: "finance/receipt-vouchers/:id",
        component: <ReceiptVoucherDetailsPage />,
        hide: true,
      },
      {
        name: "Bank Accounts",
      ...
      },
      {
        ...
        path: "finance/bank-accounts/:id/edit",
        component: <BankAccountFormPage />,
        hide: true,
      },
      {
      ...
      {
        name: "Cheque Books",
        path: "finance/cheque-books",
        component: <ChequeBooksPage />,
      },
      {
        name: "Create Cheque Book",
        path: "finance/cheque-books/create",
        component: <ChequeBookFormPage />,
        hide: true,
      },
      {
        name: "Edit Cheque Book",
        path: "finance/cheque-books/:id/edit",
        component: <ChequeBookFormPage />,
        hide: true,
      },
      {
        name: "Cheque Book Details",
        path: "finance/cheque-books/:id",
        component: <ChequeBookDetailsPage />,
        hide: true,
      },
      {
      ...
      },
      {
        ...
        component: <BankTransactionFormPage />,
        hide: true,
      },
      {
        name: "Edit Bank Transaction",
        path: "finance/bank-transactions/:id/edit",
        component: <BankTransactionFormPage />,
        hide: true,
      },
      {
        name: "Bank Transaction Details",
        path: "finance/bank-transactions/:id",
        component: <BankTransactionDetailsPage />,
        hide: true,
      },
      {
      ...
      },
      {
        ...
        path: "finance/bank-reconciliations/create",
        component: <BankReconciliationFormPage />,
        hide: true,
      },
      {
        name: "Edit Bank Reconciliation",
        path: "finance/bank-reconciliations/:id/edit",
        component: <BankReconciliationFormPage />,
        hide: true,
      },
      {
        name: "Bank Reconciliation Details",
        path: "finance/bank-reconciliations/:id",
        component: <BankReconciliationDetailsPage />,
        hide: true,
      },
      {
        name: "Petty Cash Funds",
        path: "finance/petty-cash-funds",
        component: <PettyCashFundsPage />,
      },
      {
        name: "Create Petty Cash Fund",
        path: "finance/petty-cash-funds/create",
        component: <PettyCashFundFormPage />,
        hide: true,
      },
      {
        name: "Edit Petty Cash Fund",
        path: "finance/petty-cash-funds/:id/edit",
        component: <PettyCashFundFormPage />,
        hide: true,
      },
      {
        name: "Petty Cash Fund Details",
        path: "finance/petty-cash-funds/:id",
        component: <PettyCashFundDetailsPage />,
        hide: true,
      },
      {
        name: "Petty Cash Vouchers",
        path: "finance/petty-cash-vouchers",
        component: <PettyCashVouchersPage />,
      },
      {
        name: "Create Petty Cash Voucher",
        path: "finance/petty-cash-vouchers/create",
        component: <PettyCashVoucherFormPage />,
        hide: true,
      },
      {
        name: "Edit Petty Cash Voucher",
        path: "finance/petty-cash-vouchers/:id/edit",
        component: <PettyCashVoucherFormPage />,
        hide: true,
      },
      {
        name: "Petty Cash Voucher Details",
        path: "finance/petty-cash-vouchers/:id",
        component: <PettyCashVoucherDetailsPage />,
        hide: true,
      },
      {
        name: "Petty Cash Replenishments",
        path: "finance/petty-cash-replenishments",
        component: <PettyCashReplenishmentsPage />,
      },
      {
        name: "Create Replenishment",
        path: "finance/petty-cash-replenishments/create",
        component: <PettyCashReplenishmentFormPage />,
        hide: true,
      },
      {
        name: "Edit Replenishment",
        path: "finance/petty-cash-replenishments/:id/edit",
        component: <PettyCashReplenishmentFormPage />,
        hide: true,
      },
      {
        name: "Replenishment Details",
        path: "finance/petty-cash-replenishments/:id",
        component: <PettyCashReplenishmentDetailsPage />,
        hide: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        name: "Create GRN",
        path: "inventory/grns/create",
        component: <GRNFormPage />,
        hide: true,
      },
      {
        name: "Edit GRN",
        path: "inventory/grns/:id/edit",
        component: <GRNFormPage />,
        hide: true,
      },
      {
      ...
      },
      {
        ...
        component: <StockTransferFormPage />,
        hide: true,
      },
      {
      ...
      },
      {
        ...
        component: <StockAdjustmentFormPage />,
        hide: true,
      },
      {
      ...
      },
      {
        ...
        component: <StockAdjustmentDetailsPage />,
        hide: true,
      },
      {
        name: "Stock Ledger",
      ...
      },
      {
        ...
        component: <OpeningStockEntriesPage />,
      },
      {
        name: "Create Opening Stock",
        path: "inventory/opening-stock/create",
        component: <OpeningStockEntryFormPage />,
        hide: true,
      },
      {
        name: "Edit Opening Stock",
        path: "inventory/opening-stock/:id/edit",
        component: <OpeningStockEntryFormPage />,
        hide: true,
      },
      {
        name: "Opening Stock Details",
        path: "inventory/opening-stock/:id",
        component: <OpeningStockEntryDetailsPage />,
        hide: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        name: "Create Customer Receipt",
        path: "invoice-center/customer-receipts/create",
        component: <CustomerReceiptFormPage />,
        hide: true,
      },
      {
        name: "Edit Customer Receipt",
        path: "invoice-center/customer-receipts/:id/edit",
        component: <CustomerReceiptFormPage />,
        hide: true,
      },
      {
        name: "Customer Receipt Details",
        path: "invoice-center/customer-receipts/:id",
        component: <CustomerReceiptDetailsPage />,
        hide: true,
      },
      {
        name: "Finance Settings",
        path: "invoice-center/finance-settings",
        component: <InvoiceCenterFinanceSettingsPage />,
        section: "Finance Integration",
      },
      {
        name: "Finance Posting",
        path: "invoice-center/finance-posting",
        component: <InvoiceCenterFinancePostingPage />,
        section: "Finance Integration",
      },
      {
        name: "Pending Postings",
        path: "invoice-center/finance-posting/pending",
        component: <InvoiceCenterFinancePostingPage />,
        hide: true,
      },
      {
        name: "Posting History",
        path: "invoice-center/finance-posting/history",
        component: <InvoiceCenterFinancePostingPage />,
        hide: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: <LicenseDocumentsPage />,
      },
      {
        name: "Batch Recall",
        path: "compliance/batch-recall",
        component: <BatchRecallPage />,
      },
      {
        name: "Batch Hold",
        path: "compliance/batch-hold",
        component: <BatchHoldPage />,
      },
      {
        name: "Expiry Disposal",
        path: "compliance/expiry-disposal",
        component: <ExpiryDisposalPage />,
      },
      {
        name: "Regulatory Records",
        path: "compliance/regulatory",
        component: <RegulatoryRecordsPage />,
      },
    ],
  },
  {
