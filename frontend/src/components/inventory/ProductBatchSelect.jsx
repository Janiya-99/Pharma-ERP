...
const ProductBatchSelect = ({ value, onChange, placeholder = "Select...", disabled = false, error = false, isMulti = false, isClearable = true, extraParams = {} }) => {
  ...
  const fetchOptions = async () => {
    ...
    try {
      ...
      console.error("Failed to load ProductBatchSelect options:", error);
    } finally {
      setLoading(false);
    }
  };
