...
const WarehouseTransferDirection = ({
  fromWarehouse,
  toWarehouse,
  fromLocation,
  toLocation,
  ...
  return (
    <div className="flex w-fit items-center gap-3 rounded-lg border border-gray-100 bg-gray-50 p-3 dark:border-navy-700 dark:bg-navy-800/50">
