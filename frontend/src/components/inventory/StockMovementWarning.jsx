...
const StockMovementWarning = ({ title = "Warning", message = "Posting this document will permanently update stock balances and create immutable stock ledger entries. This action cannot be undone." }) => {
  return (
