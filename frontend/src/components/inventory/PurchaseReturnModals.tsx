...
// Submit Modal
// ============================================================================
export const SubmitPurchaseReturnModal: React.FC<BaseModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  purchaseReturn,
...
// Approve Modal
// ============================================================================
export const ApprovePurchaseReturnModal: React.FC<BaseModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  purchaseReturn,
...
// Reject Modal
// ============================================================================
export const RejectPurchaseReturnModal: React.FC<BaseModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  purchaseReturn,
...
export const PostPurchaseReturnConfirmModal: React.FC<PostModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  purchaseReturn,
