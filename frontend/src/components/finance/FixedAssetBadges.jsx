...
export const FixedAssetStatusBadge = ({ status }) => {
...
export const DepreciationMethodBadge = ({ method }) => {
...
export const DepreciationPostedStatusBadge = ({ status }) => {
  if (!status) return null;
  const normalizedStatus = status.toLowerCase();
...
export const DisposalTypeBadge = ({ type }) => {
  if (!type) return null;
...
export const GainLossBadge = ({ amount }) => {
