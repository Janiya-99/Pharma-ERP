  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-4 lg:grid-cols-4 2xl:grid-cols-4 mb-6">
      <Card extra="!flex-row flex-grow items-center rounded-xl p-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-indigo-50 dark:bg-navy-700">
          <span className="text-xl text-indigo-500 dark:text-white">OB</span>
        </div>
        <div className="ml-4">
