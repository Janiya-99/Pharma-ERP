...
const PettyCashTotalSummary = ({
  totalAmount,
  currentFundBalance,
  voucherType,
}: {
  totalAmount?: unknown;
  currentFundBalance?: unknown;
  voucherType?: unknown;
}) => {
  ...
  return (
    <div className="mt-6 flex flex-col items-end space-y-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <span
              className={`text-sm font-bold ${
                isOverdrawn ? "text-red-500" : "text-green-500"
              }`}
            >
      ...
      {isOverdrawn && (
        <div className="w-full max-w-sm rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-600 dark:border-red-800/30 dark:bg-red-900/20 dark:text-red-400">
