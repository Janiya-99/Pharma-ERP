...
const PettyCashLinesTable = ({ lines, onChange, readOnly }) => {
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {readOnly ? (
                      ...
                      <select
                        ...
                        onChange={(e) => handleChange(index, "account_id", Number(e.target.value))}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {readOnly ? (
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange(index, "line_description", e.target.value)}
