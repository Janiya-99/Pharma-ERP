...
const SoftwareSelector = ({ value, onChange, disabled = false, required = false, className = "" }: { value?: unknown; onChange?: unknown; disabled?: unknown; required?: unknown; className?: unknown }) => {
