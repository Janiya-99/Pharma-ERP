  ...
  return (
    <Modal
      ...
      title={
        <div className="flex items-center gap-2.5 text-amber-600 dark:text-amber-400">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50 dark:bg-amber-950/60 border border-amber-200 dark:border-amber-800">
    ...
    >
      <div className="space-y-6 text-slate-800 dark:text-slate-200">
        {/* Banner */}
        <div className="rounded-xl border border-amber-200 dark:border-amber-900/60 bg-amber-50/70 dark:bg-amber-950/40 p-4">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-4">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 p-3 text-center">
            ...
            <div className="flex-1 rounded-lg border border-indigo-200 dark:border-indigo-900/60 bg-indigo-50/50 dark:bg-indigo-950/40 p-3 text-center">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3.5">
            ...
            <p className="text-lg font-bold text-slate-900 dark:text-white">{modules.length} Active</p>
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3.5">
            <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 mb-1">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Records</span>
            </div>
            <p className="text-lg font-bold text-slate-900 dark:text-white">~{recordsCount}</p>
            <p className="text-[11px] text-slate-500">Pending & Drafts</p>
          </div>

          <div className="col-span-2 sm:col-span-1 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3.5">
            ...
            <p className="text-lg font-bold text-slate-900 dark:text-white">{branchesCount} Branches</p>
        ...
        <div className="rounded-xl bg-slate-100 dark:bg-slate-800/80 p-4 flex items-center gap-3">
          <input
            type="checkbox"
            id="confirm-impact"
            checked={confirmed}
          ...
          />
          <label htmlFor="confirm-impact" className="text-xs font-semibold text-slate-700 dark:text-slate-300 cursor-pointer select-none">
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-200 dark:border-slate-800">
          <button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="px-4 py-2 rounded-xl border border-slate-300 dark:border-slate-700 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all disabled:opacity-50"
          >
            Cancel
          </button>
          <button
