    ...
    <div className="flex h-screen bg-white font-sans text-blueMono-900 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        >
          ...
          <footer className="py-4 px-8 mb-5 border-t border-slate-200 bg-white/20 backdrop-blur-md text-xs text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-2 mt-auto">
