  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="text-slate-400 hover:bg-slate-100 hover:text-slate-600 focus:ring-slate-100/50 absolute right-3 top-3 rounded-lg p-1.5 transition-colors focus:outline-none focus:ring-2">
