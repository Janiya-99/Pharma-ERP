...
import { SalesInvoiceApprovalStatus } from '../../types/invoice-center';

interface Props {
  status: SalesInvoiceApprovalStatus;
  className?: string;
}

export const SalesInvoiceApprovalStatusBadge: React.FC<Props> = ({ status, className }) => {
  const getBadgeColor = () => {
    switch (status) {
