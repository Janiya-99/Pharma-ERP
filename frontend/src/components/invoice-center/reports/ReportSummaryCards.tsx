...
export const ReportSummaryCards: React.FC<ReportSummaryCardsProps> = ({ items, isLoading = false }) => {
  const formatValue = (value: string | number, format?: 'currency' | 'number' | 'text') => {
    if (format === 'currency') {
