...
import { CustomerReceiptApprovalStatus } from '../../types/invoice-center';

interface Props {
  status: CustomerReceiptApprovalStatus;
  className?: string;
}

export const CustomerReceiptApprovalStatusBadge: React.FC<Props> = ({ status, className }) => {
  const getBadgeColor = () => {
    switch (status) {
