...
const CustomerStatusBadge: React.FC<CustomerStatusBadgeProps> = ({ status }) => {
  const colors: Record<string, string> = {
    ...
    inactive: "bg-gray-100 text-gray-700 border-gray-300 dark:bg-navy-700 dark:text-gray-300 dark:border-navy-600",
    blocked: "bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-900/30 dark:text-rose-400 dark:border-rose-800",
    on_hold: "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800",
  };
