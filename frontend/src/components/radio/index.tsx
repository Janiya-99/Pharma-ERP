const Radio = (props: {
  ...
  return (
    <input
      ...
      name={name}
      type="radio"
      className={`before:contet[""] duration-[0.2s] before:duration-[0.2s] relative h-5 w-5 cursor-pointer
       appearance-none rounded-full border !border-gray-300 transition-all before:absolute
       before:left-[50%] before:top-[3px] before:h-3 before:w-3 before:translate-x-[-50%] before:rounded-full before:transition-all dark:!border-gray-800
       ${
         color === "red"
