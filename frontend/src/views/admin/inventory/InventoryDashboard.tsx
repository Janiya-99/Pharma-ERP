  ...
  return (
    <div className="flex flex-col gap-5 py-5">
      <div className="flex flex-col mb-4">
        <h1 className="text-2xl font-bold text-navy-700 ">Inventory Dashboard</h1>
      ...
      <div className="mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3">
        <Widget
          icon={<MdInventory2 className="h-6 w-6 text-brand-500 " />}
          title="Total Products"
          subtitle={stats.products.toString()}
        />
        <Widget
          icon={<MdStorefront className="h-6 w-6 text-brand-500 " />}
          title="Warehouses"
          subtitle={stats.warehouses.toString()}
        />
        <Widget
          icon={<MdLocalShipping className="h-6 w-6 text-brand-500 " />}
          title="Suppliers"
