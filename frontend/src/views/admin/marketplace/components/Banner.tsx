    ...
    >
      <div className="w-full">
        ...
        <div className="mt-[36px] flex items-center justify-between gap-4 sm:justify-start 2xl:gap-10">
          <button className="linear rounded-md bg-white px-4 py-2 text-center text-base font-medium text-black transition duration-200 hover:!bg-white/80 active:!bg-white/70">
            Discover now
          </button>
