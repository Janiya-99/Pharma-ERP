...
// OpeningStockEntry stores the opening stock document header
type OpeningStockEntry struct {
	...
	OpeningStockNumber string    `gorm:"type:varchar(50);not null;index" json:"opening_stock_number"`
	OpeningStockDate   time.Time `gorm:"type:date;not null;index" json:"opening_stock_date"`
	...
	Lines     []OpeningStockEntryLine     `gorm:"foreignKey:OpeningStockEntryID" json:"lines"`
	Approvals []OpeningStockEntryApproval `gorm:"foreignKey:OpeningStockEntryID" json:"approvals"`
}

// TableName overrides the table name used by GORM
func (OpeningStockEntry) TableName() string {
	return "opening_stock_entries"
}
