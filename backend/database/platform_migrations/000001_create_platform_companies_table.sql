...
CREATE TABLE IF NOT EXISTS `tenant_companies` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `idx_tenant_companies_code` (`company_code`),
    UNIQUE KEY `idx_tenant_companies_dbname` (`database_name`),
    INDEX `idx_tenant_companies_deleted_at` (`deleted_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- +goose Down
DROP TABLE IF EXISTS `tenant_companies`;
